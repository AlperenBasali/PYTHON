...
#  print(type(cities))
#  print(cities[0])
#  print(cities[len(cities)-1]) #? -1. sıradakini yazar
#  print(cities[-1])
#  print(cities[0:5:2])

#  cities[0] = "Aydın" #? 0. eleman yerine atandı
#  print(cities)

#  ! Listenin sonuna eleman eklemek için;
#  cities.append("Denizli") #?APPEND Listenin sonuna eleman ekler
#  print(cities)

#  cities.insert(1,"Sakarya") #? İMSERT LİSTEDE İSTEDİĞİN YERE ELEMAN EKLER
#  print(cities)

#  cities.pop() #? SONDAKİ ELEMANI ÇIKARDI
#  print(cities)
...
# {fizik}
# {kimya}
# """)         #? f İŞARETİ JAVASCRİPTDE Kİ $ ve """ İLE YAZINCA ***
...
#  ! TUPLE KULLANIMI 
#? TUPLE KULLANIRSAN DİZİDE Kİ ELEMANLAR CİNSİ DEĞİŞTİRİLMEDİĞİ SÜRECE ASLA DEĞİŞTİRİLEMEZ!!!
